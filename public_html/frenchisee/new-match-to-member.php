...
ob_start();include ("temp.php");$html_message = ob_get_clean();	
...
$message->setSubject("Here is your matching list according to your partner preference.");


$message->setBody($html_message,'text/html');


$message->setFrom($from, 'The Greentech');


$message->setCc(array('info@thegreentech.in'));
...
$check_sent=mysqli_num_rows($DatabaseCo->dbLink->query("select * from matches_list where my_id='".$_GET['email']."' and other_id=".$index_id));
			...
			//echo "update matches_list set sent_on=now() where my_id='".$_GET['email']."' and other_id =".$index_id;	
...
<html>
  ...
  <head>
    ...
    <title>Manage | Matchmaking</title>
...
<?php
  ...
  if($fetch_sel['part_country_living']!='')
	...
	$t2=$age+8;
		...
		$sm = mysqli_num_rows($DatabaseCo->dbLink->query("select * from register_view where gender!='".$gender."' AND (( ( date_format( now( ) , '%Y' ) - date_format( birthdate, '%Y' )) - ( date_format( now( ) , '00-%m-%d' ) < date_format( birthdate, '00-%m-%d' ) ) ) BETWEEN ".$t1." AND ".$t2.") $prel $pcn $pet $pmt $pcst $phgt"));
...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <div class="col-lg-2 col-xs-6 ">
                                ...
                                <small id="count"><a  class="btn btn-info btn-sm text-danger"  target="_blank"><?php echo $sm; ?> match found</a></small>
		...
		<!--<div class="scroll-menu hidden-xs">
        	...
        	<ul class="col-xs-12">
            	...
            	<li class="col-xs-12 clearfix">
            		...
            		<a style="cursor:pointer;" onClick="delete_user();">
           		...
           		<li class="col-xs-12 clearfix">
            		...
            		<a style="cursor:pointer;" onClick="active();">
            	...
            	<li class="col-xs-12 clearfix">
            		...
            		<a style="cursor:pointer;" onClick="inactive();">
            	...
            	<li class="col-xs-12 clearfix">
            		...
            		<a style="cursor:pointer;" onClick="suspended();">
            ...
            <div class="col-lg-12 col-xs-12 col-sm-12">
          		...
          		<div class="box-top clearfix">
                	...
                	<div class="col-lg-2 col-xs-12 col-sm-6">
                    	...
                    	<a href="members.php" class="btn btn-default btn-lg btn-flat col-xs-12">
                    ...
                    <div class="col-lg-2 col-xs-12 col-sm-6">
                    	...
                    	<a href="editprofile.php" class="btn btn-default btn-lg btn-flat col-xs-12">
	...
	echo  "<div class='success-msg cf' id='success_msg'><h3>Record is updated successfully.</h3></div>";	 
	 ...
	 ?>   
            ...
            <section class="col-lg-12 col-xs-12 col-md-12 neMrgTop10">
            	...
            	<div class="box-top clearfix">
                	...
                	<div class="col-lg-12 col-xs-12 col-md-12 neMrgATop10 neselectBoxMem">
                    	...
                    	<a class="md-trigger btn btn-default btn-flat btn-lg btn-block add-details"  href="javascript:;"  onClick="submitActionForm('SEND');">  
                    	 ...
                    	 Send Email To(<?php echo $member_mail; ?>)
                                ...
                                <a class="btn btn-default btn-flat col-lg-4 col-xs-6 col-md-2" href="javascript:;"  onClick="submitActionForm('SEND');">
                            		...
                            		<i class="fa fa-envelope neMrgARight10"></i> Send Email To(<?php echo $member_mail; ?>)
            ...
            <div class="col-lg-12 col-xs-12 neMrgTop10">
