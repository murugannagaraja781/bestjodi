<?php 
    if(!isset($_SESSION['franchies_email'])){
            header("location: index.php");
			echo "<script>window.location='index'</script>";
    }
	$loggedn_user = isset($_SESSION['franchies_email'])?$_SESSION['franchies_email']:"Admin";
?>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs"><?php echo strtoupper($loggedn_user);?></span>
                </a>
                <ul class="dropdown-menu">
                  <li class="user-header">
                    <p><?php echo $_SESSION['franchies_email'];?></p>
                  </li>
                </ul>
              </li>
              <li>
