...
<html>
  <head>
    ...
    <script>
      ...
      function assign_franchies(){
        var selectedOrderBy = new Array();
        $('input[name="action_id"]:checked').each(function() {
          selectedOrderBy.push(this.value);
        }
                                                 );
        var franchies_id = $('#assign_franchies').val();
        if(selectedOrderBy!='')
        {
          $("#result").html('<img src="img/ajax_loader_blue_256.gif" style="margin-left:25%;">');
          $.ajax({
            url: 'user_action',
            type: 'POST',
            data: 'franchies_id='+franchies_id+'&user_id='+selectedOrderBy,
            success: function(data){
              allmem();
              userstatusbtn();
              alert("Record is updated successfully.");
      ...
      <div class="content-wrapper">
        ...
        <div class="scroll-menu hidden-xs">
          <ul class="col-xs-12">
            ...
            <li class="col-xs-12 clearfix">
              <a style="cursor:pointer;" onClick="active();" title="Active">
                <i class="fa fa-thumbs-up">
                </i>
              </a>
            </li>
            <li class="col-xs-12 clearfix">
              <a style="cursor:pointer;" onClick="inactive();" title="Inactive">
          ...
          <div class="row">
            <div class="col-lg-12 col-xs-12 col-sm-12">
              <div class="box-top updateSite">
                ...
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="members.php" class="btn btn-default btn-lg btn-block">
                    <i class="fa fa-users">
                    </i>All Member
                  </a>
                </div>
                ...
                <?php }else{?>
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a class="md-trigger btn btn-success btn-lg btn-block add-details"  href="javascript:;" data-modal="modal-13">
            ...
            <section class="col-lg-12 col-xs-12 col-md-12 mt-10">
              <div class="box-top mt-10">
                        ...
                        <div class="row">
                    <?php if(!isset($_SESSION['franchies_user_id'])){?>
                    <div class=" row">
                      <div class="form-group col-md-2">
                        <select name="assign_franchies" class="form-control " id="assign_franchies">
                          <option value="">Select Franchies
                          </option>
                          <?php
							$get_franchies=$DatabaseCo->dbLink->query("select * from franchies where status='APPROVED'");
							while($row123 = mysqli_fetch_object($get_franchies))
							{
							?>
                      ...
                      <div class="row">
                        <a class="btn btn-default btn-flat col-lg-2 col-xs-6 col-md-3"  onClick="assign_franchies();">
                          <i class="fa fa-user neMrgARight10">
                          </i>Assign Franchies
                        </a>
                      </div>
                    </div>
