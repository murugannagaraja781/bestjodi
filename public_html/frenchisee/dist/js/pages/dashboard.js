...
$(function () {
  ...
  $('#chat-box-1').slimScroll({
    height: '250px'
  });
  $('#chat-box-2').slimScroll({
    height: '250px'
  });
  $('#chat-box-3').slimScroll({
    height: '250px'
  });
  $('#chat-box-4').slimScroll({
    height: '250px'
  });
  $('#chat-box-5').slimScroll({
    height: '250px'
  });
  ...
  var area = new Morris.Area({
    ...
    resize: true,
    data: [
	  {y: '2012 Q0', item1: 2666, item2: 2666},
