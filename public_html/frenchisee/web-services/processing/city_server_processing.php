...
{  // preparing an array
		...
		$icon= '<i class="fa  '.$likeDisLikeCss.'"></i>';
		
		$edit='<a class="btn btn-danger"  href="javascript:;" data-modal="modal-13" onClick="newWindow(\'update_city?city_id='.$row['city_id'].'\',\'\',700,540)"><i class="fa fa-pencil fa-fw"></i>
