...
<div class="row">
    ...
    <div class="row" style="margin-top:3%;">
    	...
    	<div class="form-group form-group-select2">
			...
			<div class="col-xs-4">
            	...
            	<label for="exampleInputEmail1"><b>Payment Mode :</b></label>

        	</div>

            <div class="col-xs-6">

            	<select class="form-control" name="pay_mode" id="pay_mode" style="width:99%;">
    ...
    <div class="row" style="margin-top:3%;">
    	...
    	<div class="form-group form-group-select2">
            ...
            <label for="exampleInputEmail1"><b>Activation Date :</b></label>
