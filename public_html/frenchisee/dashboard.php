...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Frenchisee | Dashboard</title>
			...
			<div class="row">
				<a href="members" class="col-lg-3 col-xs-6">
					<div class="small-box bg-white">
						<div class="inner">
							<h3><?php echo getRowCount("select count(index_id) from  register_view where franchies_id='$frenchise_id'", $DatabaseCoCount);?></h3>
							<p>All Members</p>
						</div>
				...
				<a href="memberActiveToPaid" class="col-lg-3 col-xs-6">
					<div class="small-box bg-white">
						<div class="inner">
							<h3><?php echo getRowCount("select count(index_id) from  register_view where status='Active' AND franchies_id='$frenchise_id'", $DatabaseCoCount);?></h3>
							<p>Active Members</p>
						</div>
						<div class="icon"><i class="ion ion-person"></i></div>
					</div>
				...
				<a href="memberPaidToSpotlight" class="col-lg-3 col-xs-6">
					<div class="small-box bg-white">
						<div class="inner">
							<h3><?php echo getRowCount("select count(index_id) from  register_view where status='Paid' AND franchies_id='$frenchise_id' ", $DatabaseCoCount);?></h3>
							<p>Paid Members</p>
						</div>
				...
				<a href="memberPaidToSpotlight" class="col-lg-3 col-xs-6">
					<div class="small-box bg-white">
						<div class="inner">
							<h3><?php echo getRowCount("select count(index_id) from  register_view where fstatus='Featured' AND franchies_id='$frenchise_id'", $DatabaseCoCount);?></h3>
				...
				<div class="box box-danger">
					...
					<div class="box-body">
						<ul class="users-list clearfix">
							<?php
								$exe=mysqli_query($DatabaseCo->dbLink,"select username,index_id,photo1,m_status,gender,reg_date,religion_name,caste_name,country_name,city_name,email from register_view where franchies_id='$frenchise_id' order by index_id DESC  limit 0,12");
