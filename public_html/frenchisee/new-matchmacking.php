...
$email_template = strtr($email_template, $trans);
 ...
 $select=$DatabaseCo->dbLink->query("select email,photo1,photo2,photo3,photo4,photo5,photo6,matri_id  from register where index_id =".$index_id);
	   ...
	   $row = mysqli_fetch_array($select);
		...
		is_file(unlink("../my_photos/".$row['photo7']));



		is_file(unlink("../my_photos_big/".$row['photo7']));



		is_file(unlink("../my_photos/".$row['photo8']));



		is_file(unlink("../my_photos_big/".$row['photo8']));   
          ...
          <div class="row">
            ...
            <div class="col-lg-12 col-xs-12 col-sm-12">
          		...
          		<div class="box-top clearfix">
					...
					?>
                    <div class="col-lg-2 col-xs-12 col-sm-6">
                    	<a class="md-trigger btn btn-default btn-flat btn-lg btn-block add-details"  href="?clear-filter">
							Clear Filter
                    	</a>
                    </div>
                	...
                	<div class="col-lg-12 col-xs-12 col-md-12 neMrgATop10 neselectBoxMem">
                    	...
                    	<div class="row">
                                ...
                                <a class="btn btn-default btn-flat col-lg-2 col-xs-6 col-md-2" onClick="delete_user();">
                            		...
                            		<i class="fa fa-trash-o neMrgARight10"></i> Delete
                                ...
                                <a class="btn btn-default btn-flat col-lg-2 col-xs-6 col-md-2" onClick="active();">
                            		...
                            		<i class="fa fa-thumbs-up neMrgARight10"></i>Active
                                ...
                                <a class="btn btn-default btn-flat col-lg-2 col-xs-6 col-md-3" onClick="inactive();">
                            		...
                            		<i class="fa fa-thumbs-down neMrgARight10"></i>Inactive
                                ...
                                <a class="btn btn-default btn-flat col-lg-2 col-xs-6 col-md-3"  onClick="suspended();">
                            		...
                            		<i class="fa fa-user-times neMrgARight10"></i>Suspended
