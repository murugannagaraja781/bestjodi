...
function getWhereClauseForPhoto7($status)
{
$where = "";
switch($status)
{
case 'approved':
$where = " WHERE photo7_approve='APPROVED' AND photo7!=''";
break;
case 'unapproved':
$where = " WHERE photo7_approve='UNAPPROVED' AND photo7!=''";
break;
case 'all':
$where = " WHERE photo7!=''";
break;
...
function getWhereClauseForPhoto8($status)
{
$where = "";
switch($status)
{
case 'approved':
$where = " WHERE photo8_approve='APPROVED' AND photo8!=''";
break;
case 'unapproved':
$where = " WHERE photo8_approve='UNAPPROVED' AND photo8!=''";
break;
case 'all':
$where = " WHERE photo8!=''";
break;
