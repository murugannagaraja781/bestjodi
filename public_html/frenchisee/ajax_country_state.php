...
if ($country_id != '') {
    ...
    <?php
    $SQL_STATEMENT_state = $DatabaseCo->dbLink->query("SELECT * FROM state_view WHERE cnt_id='$country_id' and status='1' ORDER BY state_name ASC");
...
if (isset($_REQUEST['state_id'])) {
    ...
    <?php
    $SQL_STATEMENT_city = $DatabaseCo->dbLink->query("SELECT * FROM city_view WHERE cnt_id='" . $_REQUEST['country_id'] . "' AND state_id='" . $_REQUEST['state_id'] . "' and status='1' ORDER BY city_name ASC");
