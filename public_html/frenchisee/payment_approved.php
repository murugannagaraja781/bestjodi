...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Frenchisee | Payment Request Approved</title>
...
<body class="skin-blue">
	...
	<div class="content-wrapper">
		...
		<h1 class="lightGrey">Payment Request Approved</h1>
			<ol class="breadcrumb">
				<li><a href="dashboard"><i class="fa fa-home"></i> Home</a></li>
				<li class="active">Payment Request Approved</li>
			</ol>
		</section>
		<!-- /.content -->
                ...
                <div class="box-body">
                  <form method="post" action="AddFrenchies" id="action_form">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                       <?php 
                        $commision1 = $DatabaseCo->dbLink->query("select * from frenchise_commision where frenchise_id='$frenchise_id' AND status='APPROVED'");
	...
	<script type="text/javascript">
		setPageContext("payment","payment_approved");
	</script>
