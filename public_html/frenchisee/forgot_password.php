...
$res=mysqli_query($DatabaseCo->dbLink,"select * from franchies where email='$email' and status='APPROVED'") 
...
$sql=mysqli_query($DatabaseCo->dbLink,"update franchies set password='$upasswd' where email='$email'") 
or die(mysqli_error($DatabaseCo->dbLink));
...
Dear, Admin <br/>
Registration Center is : $registration_center <br/>
