              ...
              <div class="box-top updateSite">
                ...
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="memberMessageDetails?email_status=all" class="btn btn-success btn-lg btn-block">
                    <i class="fa fa-list">
                    </i>All Message <span class="badge">
                    <?php echo getRowCount("select count(mes_id) from  messages", $DatabaseCo); ?></span>
                  </a>
                </div> 
                </div>
              </div>
              ...
              <div class="col-xs-12 mt-10">
                ...
                <div class="box box-success">
                  <div class="box-header">
                    <h3 class="box-title">
                      <?php echo strtoupper($email_status); ?> MESSAGE LIST
                    </h3>
                  </div>
                  <!-- /.box-header -->
...
?>
                          <tr>
                            <td>
                              ...
                              <label for="Item <?php echo $DatabaseCo->dbRow->mes_id; ?>" class="label2">&nbsp;
                              </label>	
                            </td>
                            <td>
...
?>
              ...
              <div class="col-lg-12 col-xs-12 col-sm-12">
                <h4>There are no data for 
                  <?php echo strtoupper($email_status); ?> Message. Please add data.
                </h4>
                <br/>
