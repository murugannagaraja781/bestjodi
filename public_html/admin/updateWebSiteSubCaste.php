...
?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-default btn-sm md-trigger edit-popup"  href="javascript:;" data-modal="modal-13" data-id="<?php  echo $DatabaseCo->dbRow->ocp_id;?>" data-sub_caste_name="<?php  echo $DatabaseCo->dbRow->sub_caste_name;?>" data-ocp_status="<?php  echo $DatabaseCo->dbRow->status;?>">
