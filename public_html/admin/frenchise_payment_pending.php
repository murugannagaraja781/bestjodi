...
if(isset($_POST['approve'])){
	$id=$_POST['id'];
	$payment_approve = $DatabaseCo->dbLink->query("UPDATE frenchise_commision set status='APPROVED' WHERE  id='$id'");
	?>
	<script>window.location='frenchise_payment_pending.php';alert('Approved Successfully');</script>";
	<?php
}
?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin | Frenchise Payment Pending
    </title>
      ...
      <div class="content-wrapper"> 
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Franchise Payment Pending
            </li>
          </ol>
        </section>
        <!-- Main content -->
          ...
          <div class="row">
            ...
            <div class="col-xs-12 mt-10"> 
              ...
              <div class="box">
                   ...
                   <h4 class="">Frenchise Payment Request Pending</h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                       <form action="" method="post">
                        <?php           
						 $commision1 = $DatabaseCo->dbLink->query("select * from frenchise_commision where status='PENDING'");
                        ...
                        <tr>
                          ...
                          <td>
                           <?php 
								$id=$DatabaseCo->dbRow->frenchise_id;
								$fren_detail = $DatabaseCo->dbLink->query("select * from franchies where id='$id'");
								$fetch=mysqli_fetch_array($fren_detail);
							  ?>
                            <a href="#myModal" data-toggle="modal" class="btn btn-green">Bank Details</a>
										...
										<div class="modal-body">
											<div class="row">
												...
												<div class="col-xs-12 mb-15">
													...
													<div class="col-lg-8">
														<b><?php echo $fetch['acc_bank_name'] ; ?></b>
													</div>
												</div>
												<div class="col-xs-12 mb-15">
													<div class="col-lg-4">
                          ...
                          <td>
                           <input type="submit" value="Approve" name="approve" class="btn btn-green">
                           <input type="hidden" value="<?php echo $DatabaseCo->dbRow->id ; ?>" name="id">
                          </td>
                        </tr>
                        <?php
}
