...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin | Manage sms Templetement
    </title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Add NewSMS Templete
            </li>
          </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="col-lg-12 col-xs-12 col-sm-12">
              <div class="box-top clearfix">
                <div class="col-lg-3 col-sm-4">
                  <a class="md-trigger btn btn-default btn-flat btn-lg btn-block add-details"  onclick="window.location='sms_templete?action=ADD'" href="javascript:;" data-modal="modal-13">
                    <i class="fa fa-plus">
                    </i>Add SMS Templete
                  </a>
                </div>
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="adminsms?sms_status=all" class="btn btn-success btn-lg btn-flat col-xs-12">
                    <i class="fa fa-list">
                    </i>All sms Templete(
                ...
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="adminsms?sms_status=approved" class="btn btn-success btn-lg btn-flat col-xs-12">
                    <i class="fa fa-thumbs-up">
                    </i>Approved sms Templeteste(
                    <?php echo getRowCount("select count(temp_id) from sms_templete where  status='APPROVED'",$DatabaseCo);?>)
                  </a>
                </div>
                <div class="col-lg-3 col-xs-12 col-sm-4">
                  <a href="adminsms?sms_status=unapproved" class="btn btn-success btn-lg btn-flat col-xs-12">
                    <i class="fa fa-thumbs-down">
                    </i>Unapproved sms Templeteste(
              ...
              <div class="col-xs-12">
                ...
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">
                      <?php echo strtoupper($sms_status); ?> sms Templete List
                    </h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <form method="post" action="adminsms" id="action_form">
                      <table id="example1" class="table table-bordered table-striped">
                        <thead>
                          <tr>
                            ...
                            <th width="30%">Templete Name
                            </th>
                            <th width="20%">Templete Contant
                            </th>
                          </tr>
                        </thead>
                        <tbody>
...
?>
              <div class="col-lg-12 col-xs-12 col-sm-12">
                <h4>There are no data for 
                  <?php echo strtoupper($sms_status); ?> Main Menu. Please add data.
                </h4>
                <br/>
