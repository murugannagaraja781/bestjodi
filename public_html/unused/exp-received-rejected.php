...
<html lang="en">
  <head>
    ...
    <title> Express Interest Received & Rejected - New Matri website</title>
                ...
                <div class="row">
                  		<div class="gt-exp-strip gt-margin-top-0">
                                ...
                                <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-5 col-xs-7  hidden-xs hidden-sm hidden-md">
                                	<a href="" class="btn gt-btn-green"><i class="fa fa-check gt-margin-right-10"></i>Accept</a>
                                </div>
                                <div class="col-xxl-2 col-xl-3 col-md-5 col-xs-6  hidden-xs hidden-sm hidden-md">
                               	 	<a href="" class="btn btn-danger"><i class="fa fa-times gt-margin-right-10"></i>Reject</a>
                                </div>
                            ...
                            <?php include"parts/express-interest-received.php"; ?>
                            <?php include"parts/express-interest-received.php"; ?>
                            <?php include"parts/express-interest-received.php"; ?>   
