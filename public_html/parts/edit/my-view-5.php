...
$no_of_brothers = mysqli_real_escape_string($DatabaseCo->dbLink, $_REQUEST['no_of_brothers']);
$no_of_sisters = mysqli_real_escape_string($DatabaseCo->dbLink, $_REQUEST['no_of_sisters']);
$nsm = mysqli_real_escape_string($DatabaseCo->dbLink, $_REQUEST['nsm']);
$nbm = mysqli_real_escape_string($DatabaseCo->dbLink, $_REQUEST['nbm']);
...
echo $DatabaseCo->dbRow->no_of_brothers . "&nbsp;&nbsp;Brother";
} else {
echo 'No brother';
}
?>
...
echo $DatabaseCo->dbRow->no_of_sisters . "&nbsp;&nbsp;Sister";
} else {
echo 'No Sister';
}
?>
