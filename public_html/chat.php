...
?>
<?php
$select1="select * from payments where pmatri_id='$chat_user'";
...
//alert(minimizeChatBox);
	...
	.addClass("chatbox")
	<?php 
	$select1="select chat from payments where pmatri_id='".$_SESSION['user_id']."'";
$exe1=mysqli_query($DatabaseCo->dbLink,$select1) or die(mysqli_error($DatabaseCo->dbLink));
$fetch1=mysqli_fetch_assoc($exe1);
	?>
