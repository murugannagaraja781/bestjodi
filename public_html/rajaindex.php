        ...
        <div id="body" style="display:none">
            <div id="wrap">
                ...
                <section class="gt-bg-vendor">
                	<div class="container">
                		<div class="col-xl-16">
                			<h3 class="text-center">Browse our vendors</h3>
                			<h5 class="text-center">Check it our vendors to make wedding arrangment at one place.</h5>
                		</div>
                		<div class="row">
							<div class="col-xxl-16 text-center">
								<a href="vendors/index" class="">Browse Vendor</a>
							</div>
                		</div>
                	</div>
                </section>
