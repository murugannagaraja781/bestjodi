...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(".thumb a").click(function(){
      ...
      var largePath = str.replace("my_photos", "my_photos_big");
        ...
        <table width="100%" align="left" border="0" class="verdana_12">
          <tr class="verdana_12">
            <td valign="top" align="center" style="text-align:center;">
              <img src="my_photos_big/<?php echo $res1['photo1'];?>" width="500px" height="400px"  id="largeImg1" alt="Large image" title="<?php echo $res1['photo1']; ?>"/>
              <br />
              <br />
